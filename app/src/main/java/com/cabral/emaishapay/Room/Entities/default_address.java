...
@Entity(tableName = "default_address")
public class default_address {
    ...
    public default_address(int default_id, String customers_id, String entry_firstname, String entry_lastname, String entry_street_address, String entry_postcode, String entry_city, String entry_country_id, String entry_latitude, String entry_longitude, String entry_contact, String is_default) {
