 ...
 */
class MerchantOrderViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    companion object {
        fun create(parent: ViewGroup): MerchantOrderViewHolder {
            val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.online_order_item, parent, false)
            return MerchantOrderViewHolder(view)
        }
    }
}
