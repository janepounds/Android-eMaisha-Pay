...
public class PopularProductsAdapter extends RecyclerView.Adapter<PopularProductsAdapter.MyViewHolder>{
    ...
    public PopularProductsAdapter(List<ProductDetails> productList,Context context){
    ...
    @Override
    public PopularProductsAdapter.MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.buy_input_product_home_card, parent, false);

        return new PopularProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final PopularProductsAdapter.MyViewHolder holder, final int position){
