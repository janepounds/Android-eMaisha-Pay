...
//                                    2);
                            ...
                            Snackbar snackbar = Snackbar.make(binding.credentialContainer, message, Snackbar.LENGTH_LONG);
        ...
        if (requestCode == CheckPermissions.PERMISSIONS_REQUEST_CAMERA) {
            if (grantResults.length > 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED && grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.CAMERA)) {
                    ...
                    Toast.makeText(context, getString(R.string.permission_rejected), Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    private void pickImage() {
        ...
        Intent chooseImageIntent = ImagePicker.getImagePickerIntent(context);
